...
$redondeosMixer = explode(",", $redondeosMixer);
    ...
    $pdf->SetFillColor(236,236,236);
    $pdf->Cell(30,9,tomaPorcentajeMS('p1',$filaInsumos['p1'],$conexion).' %',0,0,'C',1);                
    $pdf->SetFillColor(245,245,245);
    ...
    for ($i=1; $i < 11 ; $i++) { 
        ...
        if($filaInsumos[$producto] != ''){ 
            ...
            $pdf->SetFillColor(236,236,236);
            $pdf->Cell(30,9,tomaPorcentajeMS($producto,$filaInsumos[$producto],$conexion).' %',0,0,'C',1);                
    ...
    $pdf->Cell(15,9,'',0,0,'L',1);
    $pdf->Cell(30,9,'',0,0,'C',1);
    $pdf->Cell(20,9,$totalMS.' Kg',0,0,'C',1);
