      ...
      <table class="table table-hover">
        ...
        <tbody>
          ...
          while($fila = mysqli_fetch_array($queryFormulas)){ 
            ...
            <div class="modal fade zindex-<?php echo $fila['id'];?>" style="width: 1000px;height:500px;margin: 0 auto;margin-left:-500px;z-index:99!important;background-color:transparent" id="formula<?php echo $fila['id'];?>" tabindex="-1" role="dialog" aria-labelledby="modalFormula" aria-hidden="true">
